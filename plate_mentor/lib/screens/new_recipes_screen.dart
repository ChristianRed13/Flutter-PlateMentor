...
class NewRecipesScreen extends StatefulWidget {
  static const id = 'new_recipes_screen';

  @override
  State<NewRecipesScreen> createState() => _NewRecipesScreenScreenState();
}

class _NewRecipesScreenScreenState extends State<NewRecipesScreen> {
        ...
        child: BlocBuilder<RecipeBloc, RecipeState>(
          builder: (context, state) {
            ...
            if (state is RecipeInitial) {
              recipeBloc.add(FetchNewRecipes());
            }
